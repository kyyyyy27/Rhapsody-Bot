...
const Store = require("./worker/lib/Store.js") //makeInMemoryStore({ logger: pino().child({ level: 'silent', stream: 'store' }) })
...
console.log(color("│ > Youtube/Script : In channel yt DEFFBOTZZ")) 
console.log(color(' ====================================================','red')) 
console.log(color(' ====================================================','red'))
console.log(color('│ + Pembuat Script : https://wa.me/6289501060783    │ '))
console.log(color(' ====================================================','red'))
console.log(color('[ By Deff ]', 'cyan'), color('Bot Sudah Online!'))
